...
ITCdataPre = read.csv(file = 'R_HyperbolicPreITC_balanced_5_15_20.csv',header = TRUE)
ITCdataPost = read.csv(file = 'R_HyperbolicPostITC_balanced_5_15_20.csv',header = TRUE)
